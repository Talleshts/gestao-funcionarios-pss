 ...
 * @author tallesh
 */
public abstract class CSVLoggerAdapter implements ILoggerAdapter{
    private static final Logger LOGGER = LogManager.getLogger(CSVLoggerAdapter.class);
    ...
    public void logFalhaOperacao(String operacao, String nome, String usuario, String mensagem) {
        ...
        LOGGER.error(formatCSV(message));
    }


    private String formatCSV(String message) {
        // Lógica de formatação para CSV
        return message;
    }
