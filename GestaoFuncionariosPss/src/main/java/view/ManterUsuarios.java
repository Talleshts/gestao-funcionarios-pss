 ...
 * @author Arthu
 */
public class ManterUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnConsultarConsulta.setText("Visualizar");

        btnCancelarConsulta.setText("Voltar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterUsuarios().setVisible(true);
            }
        });
    }
