 ...
 * @author Arthu
 */
public class MsgExclusaoView extends javax.swing.JFrame {

    /**
     * Creates new form MensagemExclusao
     */
    public MsgExclusaoView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MsgExclusaoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MsgExclusaoView().setVisible(true);
            }
        });
    }
